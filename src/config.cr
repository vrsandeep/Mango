...
class Config
  private OPTIONS = {
    ...
    "library_path"                        => "/mango/data/main/library",
    "library_cache_path"                  => "/mango/data/main/library.yml.gz",
    "db_path"                             => "/mango/data/main/mango.db",
    "queue_db_path"                       => "/mango/data/main/queue.db",
    "scan_interval_minutes"               => 5,
    "thumbnail_generation_interval_hours" => 24,
    "log_level"                           => "debug",
    "upload_path"                         => "/mango/data/main/uploads",
    "plugin_path"                         => "/mango/data/main/plugins/plugins",
